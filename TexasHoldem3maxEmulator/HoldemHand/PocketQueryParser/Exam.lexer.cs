...
//%Card+3
/// <exclude/>
public class HoldemCard : TOKEN{ public override string yyname { get { return "Card";}}
/// <exclude/>
public override int yynum { get { return 3; }}
/// <exclude/>
 public HoldemCard(Lexer yyl):base(yyl) {}}
/// <exclude/>
public class Card_1 : HoldemCard {
  /// <exclude/>
...
/// <exclude/>
public static object Card_factory(Lexer yyl) { return new HoldemCard(yyl);}
/// <exclude/>
